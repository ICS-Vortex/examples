 ...
 */
final class Version20210924071535 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournaments ADD CONSTRAINT FK_E4BCFAC38BA5E589 FOREIGN KEY (aircraft_class_id) REFERENCES aircraft_classes (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
